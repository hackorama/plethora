...
<xsl:template match="JDepend">
    ...
    <style type="text/css">
      ...
      table.details td.green {
        background:#66ff66;
      }
      table.details td.red {
        background:#ff6666;
      }
      p {
        line-height:1.5em;
    ...
    <p align="right">Using <a href="http://www.clarkware.com/software/JDepend.html">JDepend</a> and <a href="http://jakarta.apache.org">Ant</a>.</p>
    <hr size="2" />

    <p align="center">
    <a href="jdepend.png"><img src="jdepend.png" width="1200" alt="jdepend graph" onerror='this.width=0'/></a>
    </p>
    ...
    <xsl:for-each select="./Packages/Package">
        <xsl:if test="count(error) = 0">
            <tr>
           	...
           	<xsl:choose>
        		<xsl:when test="Stats/D &gt; 0.80">
                <td align="right" class="red"><xsl:value-of select="Stats/D"/></td>
           		</xsl:when>
        		<xsl:when test="Stats/D &gt; 0.20">
                <td align="right"><xsl:value-of select="Stats/D"/></td>
           		</xsl:when>
        		<xsl:otherwise> 
                <td align="right" class="green"><xsl:value-of select="Stats/D"/></td>
        		</xsl:otherwise> 
           	</xsl:choose>
